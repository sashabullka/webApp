...
class ProectGetDeleteHandler(val renderer: TemplateRenderer, val listProects: MutableList<Proect>, val getProectByName: GetProectByName) : HttpHandler {
    ...
    override fun invoke(request: Request): Response {
        ...
        val viewModel = ProectDeleteVM(proect,listProects)
