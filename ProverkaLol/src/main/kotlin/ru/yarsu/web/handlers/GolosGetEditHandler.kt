...
class GolosGetEditHandler(val renderer: TemplateRenderer,val listProects: MutableList<Proect>,val getProectByName: GetProectByName,val storage: ProectsStorage,) : HttpHandler {
    override fun invoke(request: Request): Response {
        ...
        val viewModel = GolosEditVM(golos,listProects)
