...
class GolosHandler(val renderer: TemplateRenderer,val listProects: MutableList<Proect>,val getProectByName: GetProectByName) : HttpHandler {
    override fun invoke(request: Request): Response {
        ...
        val golos = ProectsStorage(listProects).votesById(id,proect)
        val viewModel = GolosVM(golos, listProects, page, proect)
